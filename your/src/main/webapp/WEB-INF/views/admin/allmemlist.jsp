...
<div class="container-fluid px-4">
	<h1 class="mt-4">회원정보관리</h1>
		<div class="card mb-4">
			<div class="card-header">
			<i class="fas fa-table me-1"></i>회원정보리스트
				...
				<div class="card-body">
						...
						<col width="200"><col width="150"><col width="350"><col width="450">
...
<c:forEach items="${allmemlist}" var="all" varStatus="i">
                           	<tbody>
                            	<tr>
                                   ...
                                   <td style="text-align: center;">${all.id}</td>
                                   <td style="text-align: center;">${all.name}</td>
                                   <td style="text-align: center;">${all.nickname}</td>
                                   <td style="text-align: center;">${all.birth}</td>
                                   <td style="text-align: center;">${all.gender}</td>
                                   <td style="text-align: center;">${all.email}</td>
                                   <td style="text-align: center;">
                                   <c:choose>
										<c:when test="${all.address1.length() > 25}">
										${all.address1.substring(6,25)}...
										</c:when>
										<c:otherwise>
											${all.address1}
										</c:otherwise>
                                   ...
                                   <td style="text-align: center;">
									<c:choose>
									    <c:when test="${all.auth eq '0'}">
										🌱&nbsp;회원
									    </c:when>
									    <c:when test="${all.auth eq '1'}">
									    관리자
									    </c:when>
									    <c:otherwise>
									    🍃&nbsp;탈퇴 
                                   ...
                                   <td style="text-align: center;">${all.joindate.substring(2,11)}</td>
                               </tr>
</c:forEach>
                            </tbody>
				</table>
