...
<div class="container-fluid px-4">
	<h1 class="mt-4">클래스목록관리</h1>
		<div class="card mb-4">
			<div class="card-header">
			<i class="fas fa-table me-1"></i>클래스목록
			 	<a style="float:right" href="<c:url value='/excelDown.do'/>">
				<img src="https://img.icons8.com/color/35/000000/export-excel.png"/>
				</a>
			</div>
				<div class="card-body">
						<table id="datatablesSimple">
						<col width="50"><col width="100"><col width="450"><col width="450">
						<col width="200"><col width="350"><col width="200"><col width="350">
						<col width="100"><col width="100">
							<thead>
								<tr>								
									<th style="text-align: center;">번호</th>
                                    <th style="text-align: center;">주최자</th>
                                    <th style="text-align: center;">수업명</th>
                                    <th style="text-align: center;">수업장소</th>
                                    <th style="text-align: center;">분류</th>
									<th style="text-align: center;">접수기간</th>
                                    <th style="text-align: center;">수강일</th>
                            ...
                            <c:forEach items="${allclasslist}" var="cl" varStatus="i">
                           	<tbody>
                            	<tr>
                                   ...
                                   <td style="text-align: center;">${cl.nickname}</td>
                                   
                                   <td style="text-align: center;">
                                   <a style="text-decoration:none" href="ccdetail.do?seq=${cl.seq}" onclick="window.open(this.href, '_blank', 'width=1400, height=600'); return false;">
                                   <c:choose>
		                            	<c:when test="${cl.title.length() > 13}">
		                            		${cl.title.substring(0, 13)}...
		                            	</c:when> 
		                            	<c:otherwise>
		                            		${cl.title} 
		                            	</c:otherwise> 
                                   ...
                                   <td style="text-align: center;">${cl.location}</td>
                                   <td style="text-align: center;">${cl.kinds}</td>
                                   <td style="text-align: center;">${cl.rdate.substring(2,11)} ~ ${cl.edate.substring(2,11)}</td>
                                   <td style="text-align: center;">${cl.cday}</td>
                                   <td style="text-align: center;">${cl.cdate1.substring(2,11)} ~ ${cl.cdate2.substring(2,11)}</td>
                                   <td style="text-align: center;">${cl.membercount} / ${cl.membernum}</td>
                                   <td style="text-align: center;">${cl.readcount}</td>
                               </tr>
                            </c:forEach>
							</tbody>
				</table>
