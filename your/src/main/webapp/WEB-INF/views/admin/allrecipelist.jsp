...
<div class="container-fluid px-4">
	<h1 class="mt-4">레시피목록관리</h1>
		<div class="card mb-4">
			<div class="card-header">
			<i class="fas fa-table me-1"></i>레시피목록
						...
						<col width="200"><col width="150"><col width="100"><col width="100">
							<thead>
								<tr>
                                    ...
                                    <th style="text-align: center;">조리시간</th>
                                    <th style="text-align: center;">조리난이도</th>
							...
							<c:forEach items="${allrecipelist}" var="re" varStatus="i">
                           	<tbody>
                            	<tr>
                                   ...
                                   <td style="text-align: center;"><a style="text-decoration:none" href="redetail.do?seq=${re.seq}" 
                                   onclick="window.open(this.href, '_blank', 'width=1400, height=600'); return false;">${re.recipetitle}</a></td>
