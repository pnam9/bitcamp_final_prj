...
<div class="login">
	<h1>YOUR</h1>
	<br>
    <form action="adminloginAf.do" name="loginForm" id="_frmForm" method="post">
    	<input type="text" name="id" placeholder="아이디" required="required" />
        <input type="password" name="pwd" placeholder="비밀번호" required="required" />
        <button id="_btnLogin" class="btn btn-primary btn-block btn-large">Login</button>
    </form>
</div>
