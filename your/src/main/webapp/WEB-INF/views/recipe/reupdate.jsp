...
<th>요리제목</th>
	<td align="left">
				...
				<textarea rows="1" cols="52" name="recipetitle" style="resize: none;">${recipe.recipetitle}</textarea>
			</td>
 			<td rowspan="3" class="img_wrap" align="center">
		<img id="img" align="left" src="upload/${recipe.newbestimg}">
	</td>
	</tr>
	<tr>
		<th>요리재료</th>
	<td align="left"  colspan="2">
		<textarea rows="4" cols="52" name="ingredient" style="resize: none;">${recipe.ingredient }</textarea>
	</td>
</tr>
	<tr>
		<th>대표사진</th>		
...
<tr class="mar">
	...
	<td align="left" colspan="2">
		<textarea rows="6" cols="100" name="recintroduce" style="resize: none;">${recipe.recintroduce }</textarea>
	</td>
</tr>
...
<col style="width:383px;" />
	...
	<div align="center"><input type="submit" class="button-slide-blue" id="btnupdate" name="btnupdate" value="레시피 수정" ></div>
</form>
